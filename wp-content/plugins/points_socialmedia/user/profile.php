...
//echo"SELECT *  from  friends where friends.sender='".$_SESSION["id"]."' AND friends.status = 1 AND friends.receiver='".$sennder."'";
...
if( empty($ress1)){ ?>
        <center><div id="sendfriend"><a href='friendrequest?receiver=<?= $res['id'];?>'>sendfriendrequest</a>
        </div></center><?php } else{?>
              <center><div id="unfriend"> <a href='unfriend?receiver=<?= $res['id'];?>&value=3' > unfriend</a> 
            </div></center>
         <?php } }  ?>
    <br>
